...
<!-- initialisation habituelle d'une page xhtml -->
	<head>
		...
		<script src="./script/jaime.js" type="text/javascript" language="javascript"></script>
		
		<!-- Lecteur VLC-->
		<script language="javascript" src="./script/jquery-vlc.js"></script> 
		<link rel="stylesheet" type="text/css" href="./style/vlc.css" /> 
